...
> **État v0.1.2-pre** *(2026-05-24)*. M0-M6 clos sous tag `v0.1.0` ; refactor v0.1.1 (consolidation post-audit, 4 ADRs, packages `internal/{thresholds,errors,testutil}` peuplés, `Trace` ventilée, anti-patron #6 gardé) livré sous commit `2cf560c`. **v0.1.2 retire tout l'outillage CI/CD** (workflows GitHub Actions + cibles Make CI-only + références doc) — projet *pure-local* (cf. ADR-0010). Source de vérité du refactor v0.1.1 (archivée) : [`docs/archive/audits/2026-05-24-AUDIT-v0.1.0-to-v0.1.1.md`](docs/archive/audits/2026-05-24-AUDIT-v0.1.0-to-v0.1.1.md) et [`docs/archive/audits/2026-05-24-AUDITPlan-v0.1.1.md`](docs/archive/audits/2026-05-24-AUDITPlan-v0.1.1.md). **Audit complet 2026-05-29/30** (HEAD `b94e93f`) : kernel sain — 0 critique · 5 majeur · 34 mineur · 15 informatif ; 6 correctifs documentaires livrés, findings code/théorie différés en ADR (voir [`docs/audits/2026-05-29-AUDIT-complet.md`](docs/audits/2026-05-29-AUDIT-complet.md)).
...
*2026-05-30 — alignement post-audit complet : couverture re-mesurée 88,2 % `-coverpkg` au `b94e93f` ; diagnostics §7.3, hash golden, godocs I3/I5, index ADR-0012 corrigés ; rapport complet indexé en §Références.*
