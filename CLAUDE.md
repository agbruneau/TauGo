...
| `internal/calibration/calibrate.go` | `CorpusEntry.Validate()` ; migration rétro-compat `ExpectedRegime → LabeledRegime` (v0.1.1). **Dette C1-01** : la CLI ne valide pas encore le corpus et le golden est en mauvais schéma → profil dégénéré (cf. § Dette technique connue + [`PRD.md` §20.2](PRD.md)). |
...
- `docs/adr/` — ADRs 0001-0010 *(0001 Clean Arch · 0002 Go 1.25 · 0003 LLM injection · 0004 AgentMeshKafka · 0005 DTO neutre · 0006 thresholds transverses · 0007 hystérèse V1 · 0008 Trace ventilée · 0009 erreurs typées · 0010 retrait CI/CD)*
